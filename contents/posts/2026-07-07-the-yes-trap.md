...
- **Genuinely small favors** that build the favor bank: the five-minute unblock, the intro, the pointer to the right doc. Cheap for you, memorable for them — this is how the shadow org chart gets built, one small reciprocity at a time. (See [The Yes-Trap](/posts/the-yes-trap/) and the shadow-org-chart notes.)
