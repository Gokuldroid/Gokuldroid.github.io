...
categories:
  - blog
---
Setting up a custom domain for our github pages has lot of benefits but at the same time it requires lot of patience. This article aims to give a picture about how the entire thing works and step-by-step guide for the same.
...
I am taking my github profile `Gokuldroid` and my custom domain `codefromdude.com` as example here.
...
Fire up a browser and go to https://<your-github-username>.github.io.

you have successfully setup a personal page in github.

Setting up domain in cloudflare,
...
<img src="/assets/blog/github-custom-domain/github-add-domain.png" alt="github add domain" style="width:100%">
<img src="/assets/blog/github-custom-domain/github-txt-record.png" alt="github txt records" style="width:100%">
- Go to cloudflare -> websites -> Add website -> Type your custom domain -> click on next.
<img src="/assets/blog/github-custom-domain/add-website.png" alt="cloud flare add website" style="width:100%">
- Select your plan that you need. (you can choose free plan)-> click next.
<img src="/assets/blog/github-custom-domain/select-plan.png" alt="select plan" style="width:100%">
...
<img src="/assets/blog/github-custom-domain/godaddy-nameserver.png" alt="godaddy name server" style="width:100%"> 

This will take few hours to take effect.

- once the nameserver changes got propagated, you can verify that in cloudflare console.
<img src="/assets/blog/github-custom-domain/change-nameservers.png" alt="cloudflare verification" style="width:100%">
- once you verified, the site will be active in cloud flare. till now we have configured the domain provider and cloudflare.
<img src="/assets/blog/github-custom-domain/site-overview.png" alt="site active" style="width:100%">
...
<img src="/assets/blog/github-custom-domain/github-txt-record.png" alt="github domain verification" style="width:100%">
- Once you verified the domain in github, configure the same in github repository settings.
<img src="/assets/blog/github-custom-domain/github-pages-settings.png" alt="" style="width:100%">
- Now your github site is served at your custom domain. you can enable HTTPS settings in cloudflare and github repository settings to serve HTTPS by default.